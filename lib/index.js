...
exports.default = _postcss2.default.plugin('postcss-plugin-px2rem', function (options) {
  ...
  var unit = defaultOpts.customadaption || "epx";
  ...
  return function (css) {
    css.walkDecls(function (decl, i) {
      ...
      // 2st check 'epx'
      if (_decl.value.indexOf(defaultOpts.customadaption||"epx") === -1) return;
    ...
    if (opts.mediaQuery) {
      css.walkAtRules('media', function (rule) {
        var _rule = rule;
        if (_rule.params.indexOf(defaultOpts.customadaption||"epx") === -1) return;
